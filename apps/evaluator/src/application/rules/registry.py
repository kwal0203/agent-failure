...
SUPPORTED_BUNDLES: dict[tuple[str, str, int], RuleBundle] = {
    ("agent-prompt-injection", "v1", 1): PROMPT_INJECTION_V1_BUNDLE,
    ("agent-tool-misuse", "v1", 1): TOOL_MISUSE_V1_BUNDLE,
    ("code-execution", "v1", 1): CODE_EXECUTION_V1_BUNDLE,
    ("agent-memory-poisoning", "v1", 1): MEMORY_POISONING_V1_BUNDLE,
}
