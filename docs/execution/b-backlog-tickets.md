...
1. P0-E1-T1 Create session lifecycle schema  
2. P0-E1-T2 Implement lifecycle transition service  
3. P0-E1-T3 Implement idempotent session creation path  
4. P0-E3-T1 Implement WebSocket session manager  
5. P0-E5-T1 Build Agent Harness session loop  
6. P0-E5-T2 Integrate model gateway provider  
7. P0-E3-T2 Implement USER\_PROMPT handling  
8. P0-E3-T3 Emit typed stream messages  
9. P0-E1-T4 Implement session metadata endpoint  
10. P0-E4-T1 / P0-E4-T2 / P0-E4-T3 to move from local path to staging runtimes
